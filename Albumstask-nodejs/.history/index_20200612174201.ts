...
app.get('/getByAlbumId', function (req: any, res: any) {
    ...
    con.query('select titledata.title_id, titledata.title_name,artistsdata.artist_name, artistsdata.profession,genre.genre_id, genre.genere_name,'
        + 'albumsdata.album_name, albumsdata.year, albumsdata.album_id '
        + 'from titledata, artistsdata, genre, albumsdata'
        + ' where(title_id, artist_id, genre_id, album_id)'
        + ' =any(select title_id, artist_id, genre_id, album_id '
        + 'from musicdata where album_id ='+album_id+')', (error: any, results: any) => {
            if (error) throw error;
            res.send(JSON.stringify(results));
        });
...
app.get('/getByArtistId', function (req: any, res: any) {
    const artist_id: any = req.query.artist_id;
   con.query('select titledata.title_id, titledata.title_name,artistsdata.artist_name, artistsdata.profession,genre.genre_id, genre.genere_name,'
       + 'albumsdata.album_name, albumsdata.year, albumsdata.album_id '
       + 'from titledata, artistsdata, genre, albumsdata'
       + ' where(title_id, artist_id, genre_id, album_id)'
       + ' =any(select title_id, artist_id, genre_id, album_id '
       + 'from musicdata where artist_id = '+artist_id+')', (error: any, results: any) => {
           if (error) throw error;
           res.send(JSON.stringify(results));
       });
...
app.get('/getByGenreId', function (req: any, res: any) {
    const genre_id: any = req.query.genre_id;
   con.query('select titledata.title_id, titledata.title_name,artistsdata.artist_name, artistsdata.profession,genre.genre_id, genre.genere_name,'
       + 'albumsdata.album_name, albumsdata.year, albumsdata.album_id '
       + 'from titledata, artistsdata, genre, albumsdata'
       + ' where(title_id, artist_id, genre_id, album_id)'
       + ' =any(select title_id, artist_id, genre_id, album_id '
       + 'from musicdata where genre_id = '+genre_id+')', (error: any, results: any) => {
           if (error) throw error;
           res.send(JSON.stringify(results));
       });
...
app.get('/getByTitleId', function (req: any, res: any) {
    const title_id: any = req.query.title_id;
   con.query('select titledata.title_id, titledata.title_name,artistsdata.artist_name, artistsdata.profession,genre.genre_id, genre.genere_name,'
       + 'albumsdata.album_name, albumsdata.year, albumsdata.album_id '
       + 'from titledata, artistsdata, genre, albumsdata'
       + ' where(title_id, artist_id, genre_id, album_id)'
       + ' =any(select title_id, artist_id, genre_id, album_id '
       + 'from musicdata where title_id = '+title_id+')', (error: any, results: any) => {
           if (error) throw error;
           res.send(JSON.stringify(results));
       });
