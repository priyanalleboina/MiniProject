...
con.connect((err: any) => {
    ...
    var sql = "CREATE TABLE tiltledata (title_id INT(10) NOT NULL AUTO_INCREMENT,title_name VARCHAR(255))";
    con.query(sql, function (err:any, result:any) {
        if (err) throw err;
        console.log("Table created");
    });
    var sql = "CREATE TABLE artistsdata (artist_id INT(10) NOT NULL AUTO_INCREMENT,artist_name VARCHAR(255), profession VARCHAR(255))";
    con.query(sql, function (err:any, result:any) {
        if (err) throw err;
        console.log("Table created");
    });
